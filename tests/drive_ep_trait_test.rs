...
fn drive_root() {
    ...
    assert_eq!(drive_info.name().as_str(), "root");
    assert_eq!(
        drive_info.web_url().as_str(),
...
fn drive_root_child() {
    ...
    assert_eq!(drive_value[1].folder().unwrap().child_count(), 12);
}
...
fn shared_with_me() {
    ...
    let parent_ref2 = ParentReference::new(
        String::from("b!bUbEy-Q7O0yQlf5IKmlRJE8XkS_I8MdFlUCq1BlcjgmhRfAj3-Z8RY2VpuvV_tpd"),
    ...
    let file_system_info2 = FileSystemInfo::new(
        String::from("2017-09-02T03:05:02Z"),
        String::from("2017-09-02T03:05:02Z"),
    );
