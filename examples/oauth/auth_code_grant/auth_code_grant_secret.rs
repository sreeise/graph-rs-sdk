...
use graph_rs_sdk::oauth::{AuthorizationCodeCredential, ConfidentialClientApplication};
use graph_rs_sdk::*;
use url::Url;
use warp::Filter;
...
pub fn authorization_sign_in_url(client_id: &str, redirect_uri: &str, scope: Vec<String>) -> Url {
