use crate::{GraphRequest, GraphResponse, HttpClient, RequestAttribute, RequestClient, RequestType};
use crate::url::GraphUrl;
use handlebars::Handlebars;
use url::Url;
use reqwest::redirect::Policy;
use graph_error::{GraphError, GraphResult, GraphFailure, ErrorMessage};
use reqwest::header::{CONTENT_TYPE, HeaderValue, HeaderMap, IntoHeaderName};
...
pub(crate) type AsyncClient = GraphRequest<
    reqwest::Client,
    reqwest::Body,
