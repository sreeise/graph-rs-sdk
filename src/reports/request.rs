...
impl<'a, Client> ReportsRequest<'a, Client> where Client: graph_http::RequestClient {
	get!({
		doc: "Get reports",
	...
	get!({
		doc: "Invoke function getEmailActivityUserDetail",
		name: reports_get_email_activity_user_detail_ddb_2,
		response: serde_json::Value,
	...
	get!({
		doc: "Invoke function getEmailAppUsageUserDetail",
		name: reports_get_email_app_usage_user_detail_54_6b,
		response: serde_json::Value,
	...
	get!({
		...
		response: serde_json::Value,
		path: "/reports/getGroupArchivedPrintJobs(groupId={{id3}},startDateTime={{id}},endDateTime={{id2}})",
	...
	get!({
		doc: "Invoke function getOffice365ActiveUserDetail",
		name: reports_get_office_365_active_user_detail_6_8ad,
		response: serde_json::Value,
	...
	get!({
		doc: "Invoke function getOffice365GroupsActivityDetail",
		name: reports_get_office_365_groups_activity_detail_3_8f_6,
		response: serde_json::Value,
	...
	get!({
		doc: "Invoke function getOneDriveActivityUserDetail",
		name: reports_get_one_drive_activity_user_detail_c_424,
		response: serde_json::Value,
	...
	get!({
		doc: "Invoke function getOneDriveUsageAccountDetail",
		name: reports_get_one_drive_usage_account_detail_dd_7f,
		response: serde_json::Value,
	...
	get!({
		...
		response: serde_json::Value,
		path: "/reports/getPrinterArchivedPrintJobs(printerId={{id3}},startDateTime={{id}},endDateTime={{id2}})",
	...
	get!({
		doc: "Invoke function getSharePointActivityUserDetail",
		name: reports_get_share_point_activity_user_detail_b_778,
		response: serde_json::Value,
	...
	get!({
		doc: "Invoke function getSharePointSiteUsageDetail",
		name: reports_get_share_point_site_usage_detail_20_4b,
		response: serde_json::Value,
	...
	get!({
		doc: "Invoke function getSkypeForBusinessActivityUserDetail",
		name: reports_get_skype_for_business_activity_user_detail_74_4e,
		response: serde_json::Value,
	...
	get!({
		doc: "Invoke function getSkypeForBusinessDeviceUsageUserDetail",
		name: reports_get_skype_for_business_device_usage_user_detail_e_753,
		response: serde_json::Value,
	...
	get!({
		doc: "Invoke function getTeamsDeviceUsageUserDetail",
		name: reports_get_teams_device_usage_user_detail_7565,
		response: serde_json::Value,
	...
	get!({
		doc: "Invoke function getTeamsUserActivityUserDetail",
		name: reports_get_teams_user_activity_user_detail_eb_13,
		response: serde_json::Value,
	...
	get!({
		...
		response: serde_json::Value,
		path: "/reports/getUserArchivedPrintJobs(userId={{id3}},startDateTime={{id}},endDateTime={{id2}})",
	...
	get!({
		doc: "Invoke function getYammerActivityUserDetail",
		name: reports_get_yammer_activity_user_detail_1_5a_5,
		response: serde_json::Value,
	...
	get!({
		...
		name: reports_get_yammer_groups_activity_detail_da_9a,
		response: serde_json::Value,
	...
	get!({
		doc: "Invoke function getYammerGroupsActivityDetail",
		name: reports_get_yammer_groups_activity_detail_0d_7d,
		response: serde_json::Value,
	...
	get!({
		doc: "Invoke function managedDeviceEnrollmentFailureDetails",
		name: reports_managed_device_enrollment_failure_details_2b_3d,
		response: serde_json::Value,
	...
	get!({
		doc: "Invoke function managedDeviceEnrollmentTopFailures",
		name: reports_managed_device_enrollment_top_failures_afd_1,
		response: serde_json::Value,
