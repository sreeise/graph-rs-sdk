...
impl OauthUrlBuilder {
    ...
    pub fn scheme(&mut self, scheme: &str) -> &mut OauthUrlBuilder {
        self.url_params.insert(String::from("SCHEME"), String::from(scheme));
        self
    }

    pub fn host(&mut self, host: &str) -> &mut OauthUrlBuilder {
        self.url_params.insert(String::from("HOST"), String::from(host));
        self
    }

    pub fn path(&mut self, path: &str) -> &mut OauthUrlBuilder {
        self.url_params.insert(String::from("PATH"), String::from(path));
        self
    }

    pub fn query(&mut self, query: &str) -> &mut OauthUrlBuilder {
        self.url_params.insert(String::from("QUERY"), String::from(query));
        self
    }
    ...
    pub fn build(&mut self) -> String {
        if self.encoded {
            ...
            let mut domain = String::from(self.url_params.get("SCHEME").expect("Scheme not set").as_str());
            ...
            let mut url_string = String::from(self.url_params.get("SCHEME").expect("Scheme not set").as_str());
            ...
            url_string.push_str(self.url_params.get("QUERY").expect("Query not set").as_str());
