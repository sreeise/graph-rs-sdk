    ...
    Client: graph_http::RequestClient,
{
    ...
    post!({
        ...
        path: "/domains/{{id}}/microsoft.graph.forceDelete",
        params: 1,
        has_body: true
    });
    get!({
    ...
    get!({
        doc: "# Get ref of domainNameReferences from domains",
        name: list_ref_domain_name_references,
        response: Collection<serde_json::Value>,
        path: "/domains/{{id}}/domainNameReferences/$ref",
        params: 1,
        has_body: false
    });
    post!({
        doc: "# Create new navigation property ref to domainNameReferences for domains",
        name: create_ref_domain_name_references,
        response: serde_json::Value,
        path: "/domains/{{id}}/domainNameReferences/$ref",
        params: 1,
        has_body: true
    ...
    delete!({
        doc: "# Delete ref of navigation property domainNameReferences for domains",
        name: delete_ref_domain_name_references,
        response: GraphResponse<Content>,
        path: "/domains/{{id}}/domainNameReferences/$ref",
        params: 1,
        has_body: false
    ...
    post!({
        ...
        name: verify,
        response: serde_json::Value,
        path: "/domains/{{id}}/microsoft.graph.verify",
        params: 1,
        has_body: false
    });
    get!({
