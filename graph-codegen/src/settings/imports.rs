...
pub fn get_imports(resource_identity: ResourceIdentity) -> Vec<&'static str> {
    match resource_identity {
		...
		ResourceIdentity::AccessReviews =>
			vec!["crate::access_review_definitions::{AccessReviewDefinitionsIdRequest, AccessReviewDefinitionsRequest}"],
		ResourceIdentity::AccessReviewsDefinitions => vec!["crate::definition_instances::{DefinitionInstancesIdRequest, DefinitionInstancesRequest}"],
		ResourceIdentity::Admin => vec!["crate::service_announcement::ServiceAnnouncementRequest"],
		ResourceIdentity::AdministrativeUnits =>
			vec!["crate::administrative_units_members::{AdministrativeUnitsMembersRequest, AdministrativeUnitsMembersIdRequest}"],
		...
		ResourceIdentity::CalendarGroups =>
			vec!["crate::calendar::{CalendarRequest, CalendarsRequest}", "crate::events::{EventsRequest, EventRequest}"],
		...
		ResourceIdentity::Communications =>
			vec!["crate::call_records::{CallRecordRequest, CallRecordsRequest}", "crate::calls::{CallRequest, CallsRequest}"],
		...
		ResourceIdentity::GroupsConversations => vec!["crate::threads::{ThreadRequest, ThreadsRequest}"],
		ResourceIdentity::ChildFolders => { vec!["crate::messages::{MessageRequest, MessagesRequest}"] }
		ResourceIdentity::AccessReviewsDefinitionsInstances =>
			vec!["crate::definition_instance_stages::{DefinitionInstanceStagesRequest, DefinitionInstanceStagesIdRequest}"],
		...
		ResourceIdentity::EntitlementManagement =>
			vec![
				...
				"crate::access_packages::{AccessPackagesIdApiClient, AccessPackagesRequest}",
		...
		ResourceIdentity::Notebooks => vec!["crate::sections::SectionsRequest", "crate::section_groups::SectionGroupsRequest"],
		...
		ResourceIdentity::ParentNotebook => vec!["crate::sections::SectionsRequest", "crate::section_groups::SectionGroupsRequest"],
		ResourceIdentity::ParentSectionGroup =>
			vec!["crate::sections::SectionsRequest", "crate::section_groups::SectionGroupsRequest", "crate::parent_notebook::ParentNotebookRequest"],
		...
		ResourceIdentity::Plans => vec!["crate::buckets::{BucketsRequest, BucketsIdRequest}", "crate::tasks::{TasksRequest, TasksIdRequest}"],
		...
		ResourceIdentity::ChatsMessages =>
			vec!["crate::extended_properties::ExtendedPropertiesRequest", "crate::attachments::{AttachmentRequest, AttachmentsRequest}"],
		ResourceIdentity::Me =>
			vec![
		...
		ResourceIdentity::GroupsThreads => vec!["crate::posts::{PostRequest, PostsRequest}"],
		_ => vec![],
	}
}
